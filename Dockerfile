...
# Metadata labels
LABEL maintainer="Kevin Pirnie <support@podnest.us>"
LABEL description="This image contains a lightweight web server."
LABEL org.opencontainers.image.authors="Kevin Pirnie <support@podnest.us>"
