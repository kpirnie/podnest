...
// ScaffoldDir sets up the filesystem structure for a WordPress site.
func (Module) ScaffoldDir(dir string, cfg modules.ScaffoldConfig) error {
	return scaffoldDir(dir, cfg)
}

func (Module) StartupTimeout() time.Duration { return 90 * time.Second }
func (Module) HasPHPFPM() bool               { return true }
...
func (Module) RuntimeContainerRole() string { return "php" }
