...
// scaffoldDir creates the filesystem structure and writes config files for a Python site.
func scaffoldDir(dir string, cfg modules.ScaffoldConfig) error {
	...
	nginxSite, err := config.RenderNginxSite(marshalCfg(cfg.Configs[models.ConfigNginx]), models.SiteTypePython, vEnabled)
	if err != nil {
