...
export async function showEditSiteModal(site) {
                    ...
                    <div class="uk-grid-small" uk-grid>
                        ...
                        <div class="uk-width-1-2@s uk-hidden" id="es-node-version-wrap">
                            ...
                            <select class="uk-select kp-select" name="node_version">
                                <option value="1" ${site.RuntimeVersion===1?"selected":""}>Node 20 (LTS)</option>
                        ...
                        <div class="uk-width-1-1 uk-hidden" id="es-start-command-wrap">
                            ...
                            <input class="uk-input kp-input" name="start_command" type="text" value="${site.StartCommand || ""}">
                        </div>
                        <div class="uk-width-1-1 ${site.SiteType !== 1 ? "uk-hidden" : ""}" id="es-wordpress-wrap">
    ...
    typeSelect.addEventListener("change", () => updateVisibility(parseInt(typeSelect.value)));
    ...
    document.getElementById("kp-edit-site-modal")
        .addEventListener("hidden", () => document.getElementById("kp-edit-site-modal")?.remove());
}
